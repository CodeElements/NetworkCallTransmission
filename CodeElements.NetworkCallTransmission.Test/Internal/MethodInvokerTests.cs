...
namespace CodeElements.NetworkCallTransmission.Test.Internal
{
    public class MethodInvokerTests
    {
        ...
        public async Task TestMethodWithoutParameters()
        {
            ...
            var method =
                methods.GetType().GetTypeInfo().GetMethods().Single(x => x.Name == nameof(TestMethods.MethodWithoutParameters));
