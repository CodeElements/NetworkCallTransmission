...
using CodeElements.NetworkCallTransmissionProtocol.NetSerializer.TypeSerializers;

namespace CodeElements.NetworkCallTransmissionProtocol.NetSerializer
{
	...
	{
		static readonly ITypeSerializer[] s_typeSerializers = new ITypeSerializer[] {
